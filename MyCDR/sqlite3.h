...
int Sqlite_SafeUnload(Tcl_Interp *interp, int flags);
int Tclsqlite_SafeUnload(Tcl_Interp *interp, int flags);

int DbMain(void *cd, Tcl_Interp *interp, int objc,Tcl_Obj *const*objv);
int DbObjCmd(void *cd, Tcl_Interp *interp, int objc,Tcl_Obj *const*objv);
